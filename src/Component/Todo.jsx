    ...
    <>
      <div className="flex justify-center">
        ...
        >
          ...
          onClick={updateData}
          type="submit"
          className="text-white ml-[10px]  bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Update
        </button>}
      </div>
